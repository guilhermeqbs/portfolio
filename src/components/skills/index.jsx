...
// Componentes SVG customizados - Memoizados para performance
const JavaIcon = React.memo(({ className, style }) => (
  <svg className={className} style={style} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" height="24" width="24">
    <path fill="currentColor" d="M8.916025 18.42385s-0.898025 0.52225 0.6391 0.698975c1.8622 0.212425 2.81395 0.181975 4.8661 -0.206425 0 0 0.539525 0.3383 1.293025 0.6313 -4.600375 1.97165 -10.411575 -0.1142 -6.798225 -1.12385Z" />
    <path fill="currentColor" d="M8.3539 15.851025s-1.007225 0.745575 0.53105 0.904675c1.98925 0.205225 3.560225 0.222 6.278575 -0.301425 0 0 0.376 0.381175 0.9672 0.589625 -5.562125 1.62645 -11.75735 0.12825 -7.776825 -1.192875Z" />
    <path fill="currentColor" d="M13.092925 11.48655c1.133525 1.30505 -0.297825 2.47945 -0.297825 2.47945s2.878225 -1.48585 1.556375 -3.34645c-1.23455 -1.73515 -2.1813 -2.59725 2.944 -5.56975 0 0 -8.045025 2.009275 -4.20255 6.43675Z" />
...
const skillsGroups = {
  ...
  'Database': [
    { id: 'mysql', Icon: SiMysql, label: 'MySQL', percent: 70, color: '#4479A1' },
    { id: 'oracle', Icon: SiOracle, label: 'Oracle', percent: 70, color: '#F80000' },
    { id: 'ibmdb2', Icon: IbmDb2Icon, label: 'IBM DB2', percent: 55, color: '#1f70c1'},
